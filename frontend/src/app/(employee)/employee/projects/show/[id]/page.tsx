        ...
        <>
            <Page maxWidth="md">
                <TitleBar
                    ...
                    navigation="/employee/projects"
                    subtitle={`Project detail dari ${project?.title}`}
                >
                    <Button onClick={() => router.push(`/employee/projects/show/${params.id}/tasks`)}>Tambah Task</Button>
                </TitleBar>
                        ...
                        <Card>
                            ...
                            <CardContent className="-mt-6">
                                {remunerations.length > 0 ? (
                                    ...
                                    <DataListEmpty>Belum ada remuneration</DataListEmpty>
                                )}
                            </CardContent>
                        </Card>
                        <Card>
                                                    ...
                                                    <DataListItem key={member.id} className="py-2">
                                                        <div className="w-full flex-1">
                                                            <p className="text-sm leading-none font-medium">
                                                                {member.user?.name} {member.user.id === user?.id && '(Anda)'}
                                                            </p>
