        ...
        <ProjectProvider projects={projects} mutate={mutate} error={error}>
            <Page maxWidth="sm">
                <TitleBar title="Proyek">
                    <Button onClick={() => router.push('/manager/projects/create')}>Tambah</Button>
                </TitleBar>
        ...
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuItem asChild className="cursor-pointer">
                    <Link href={`/manager/projects/show/${project.id}`}>Detail</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="cursor-pointer">
                    <Link href={`/manager/projects/edit/${project.id}`}>Edit</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="cursor-pointer">
