...
function TableEmpty({ children, className, colSpan, ...props }: { colSpan?: number } & React.ComponentProps<'tr'>) {
    return (
        <TableRow className={cn('h-24 text-center', className)} {...props}>
            <TableCell colSpan={colSpan}>
                <div className="text-muted-foreground flex items-center justify-center text-sm">{children}</div>
            </TableCell>
        </TableRow>
    );
}
